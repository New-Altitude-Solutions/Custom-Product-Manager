...
/* Disable default woo quantity input if option enabled */
                ...
                $.each(option_identificator, function (i, val) {
                    ...
                    var BtnChooseValue = $('input[name="'+val+'_btn_radio"]:checked').val();
                      ...
                      if (array[val +'upload_input']) {
                        ...
                        var $output_id = $('#'+ val +'_output_upload_value');
                       ...
                       /* //"Free Option" if option=0 => Make in server side.
                        if (array[val+'_option_charge'] == "0") {

                            $('#' +val +'_output_upload_value').html('Free option');
                        }*/
