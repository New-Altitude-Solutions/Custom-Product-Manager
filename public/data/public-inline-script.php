...
'formula_notice_1' => __('Fill the input with numbers', 'custom-product-manager'),
'formula_notice_2' => __('Fill the second input', 'custom-product-manager'),
'formula_notice_3' => __('Fill the first input', 'custom-product-manager'),
'formula_notice_4' => __('Fill the input', 'custom-product-manager'),
];
