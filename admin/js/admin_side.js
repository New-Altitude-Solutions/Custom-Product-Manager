...
(function ($) {
    ...
    $(function () {
        ...
        /*
        *
        * Admin options menu tabs + functions
        *
        */
        ...
        $('.tablinks').on('click', function (e) {
            ...
            if (index == "0") {
                openCity('London'); $(this).toggleClass('active');
                var option_identificator = "op1";
                var option_identificator_id = "#op1";
                var option_identificator_class = ".op1";
                ...
                openCity('Paris'); $(this).toggleClass('active');
                ...
                openCity('Tokyo'); $(this).toggleClass('active');
            }
            else if (index == "3") {
                openCity('Berlin'); $(this).toggleClass('active');
            }
            else if (index == "4") {
                openCity('Roma'); $(this).toggleClass('active');
            }
            else if (index == "5") {
                openCity('Nantes'); $(this).toggleClass('active');
            } 
            else if (index == "6") {
                openCity('Bruxelles'); $(this).toggleClass('active');
            } 
            else if (index == "7") {
                openCity('Helsinki'); $(this).toggleClass('active');

                js_anim_settings_tab();

            } 
            else if (index == "8") {
                openCity('New-york'); $(this).toggleClass('active');

                js_appearance_settings_tab();
            } 
        ...
        */
        ...
        // to prevent multiple alert firing when cancel
        ...
        $('[name=remove_settings]').unbind("click").bind("click", function(event) { 
            ...
            $(option_identificator_id + '_option_submit').on('click', function (event) {
                ...
                $('.cpm_save .fa-solid').addClass('fa-cog fa-spin');


                $(".required").each(function () {
                    //.length == "" : not prevent empty space submit // new Regex : .match(/^\s*$/g)
                    ...
                    if ($(this).is(':visible') && $(this).css('display') == 'block' && $(this).val().match(/^\s*$/g)) {
                        ...
                        $('.fa-solid').removeClass('fa-cog fa-spin');


                      /*  setTimeout(function () {
                            $(option_identificator_id + '_validation_message').html('');
                            $(".required").css('border-color', '#8c8f94');
                        }, 6000);*/
                ...
                if ($(option_identificator_id + '_calcul_formula').is(':visible') && $(option_identificator_id + '_calcul_formula').css('display') == 'block') {
                    ...
                    if ($(option_identificator_id + '_calcul_formula').val().indexOf("$user_value") == -1) {
                       ...
                       /* setTimeout(function () {
                            $(option_identificator_id + '_validation_message').html('');
                            $(option_identificator_id + '_calcul_formula').css('border-color', '#8c8f94');
                        }, 6000);*/
                    }
        ...
        function js_anim_settings_tab() {

                /*add animation to setting button*/
                $('[name=save_settings]').on('click', function() {
                    $('.cpm_save .fa-solid').addClass('fa-cog fa-spin');
                });

                if($('#quantity_related').is(':checked')) {
                    $('.total_cost_header_text_field').css('display', 'none');
                    $('.total_cost_summary_text_field ').css('display', 'none');
               

                } else {
                    $('.total_price_header_text_field').css('display', 'none');
                    $('.total_price_summary_text_field').css('display', 'none');
                 
                }
                $('#quantity_related').on('change', function() {

                        if($(this).is(':checked')) {
                            $('.total_cost_header_text_field').css('display', 'none');
                            $('.total_cost_summary_text_field ').css('display', 'none');
                            $('.total_price_header_text_field').css('display', 'block');
                            $('.total_price_summary_text_field').css('display', 'block');

                        } else {
                            $('.total_price_summary_text_field').css('display', 'none');
                            $('.total_price_header_text_field').css('display', 'none');
                            $('.total_cost_header_text_field').css('display', 'block');
                            $('.total_cost_summary_text_field ').css('display', 'block');
                        }
                });
